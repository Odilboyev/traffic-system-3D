const Loader = ({ minHeight = "80vh" }) => {
  return (
    <div
      className={` top-0 left-0 w-full min-h-[${minHeight}]  dark:bg-gray-900/80 backdrop-blur-md rounded bg-opacity-75 flex items-center justify-center `}
    >
