...
// import TrafficLight from "./components/trafficLight"; // Adjust the import if needed
...
const RoadDrawing = () => {
  const [config, setConfig] = useState({
    north: { lanesFrom: 4, lanesTo: 2, visible: true, direction: "vertical" },
    south: { lanesFrom: 2, lanesTo: 3, visible: true, direction: "vertical" },
    east: { lanesFrom: 4, lanesTo: 4, visible: true, direction: "horizontal" },
    west: { lanesFrom: 2, lanesTo: 3, visible: true, direction: "horizontal" },
    sidewalkWidth: 10,
  });
