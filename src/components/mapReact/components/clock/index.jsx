...
const ClockOnMap = () => {
  ...
  return (
    <div className="w-[15vw] h-[15vw] fixed top-1 right-1 z-[9999] flex flex-col items-center justify-center p-6 bg-gray-900/80 backdrop-blur-md text-white rounded-lg shadow-lg">
