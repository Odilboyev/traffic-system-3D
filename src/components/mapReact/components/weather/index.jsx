...
const WeatherWidget = () => {
  ...
  return (
    <div className="weather w-[15vw] min-h-[15vw] right-1  z-[9999] absolute flex-col items-center justify-center p-6 bg-gray-900/80 backdrop-blur-md text-white rounded-lg shadow-lg">
