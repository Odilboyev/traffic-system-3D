export const darkLayer = {
  version: 8,
  id: "11f9cb7f-c7e2-4dfc-9b0e-b528d9038d7b",
  name: "Streets Dark",
  sources: {
    ...
    maptiler_planet: {
      url: "https://api.maptiler.com/tiles/v3/tiles.json?key=Ql4Zhf4TMUJJKxx8Xht6",
      type: "vector",
    },
  },
  layers: [
    ...
    },
    {
      ...
      "source-layer": "landcover",
      layout: { visibility: "none" },
      paint: { "fill-color": "hsl(203, 47%, 22%)", "fill-opacity": 1 },
      metadata: {},
      filter: ["==", "class", "wood"],
    },
    {
    ...
    },
    {
      ...
      minzoom: 11,
      layout: { visibility: "visible" },
      paint: { "fill-color": "hsl(226, 33%, 26%)", "fill-opacity": 1 },
      metadata: {},
      filter: ["==", "$type", "Polygon"],
    },
    {
      ...
      layout: { visibility: "visible" },
      paint: { "fill-color": "hsl(216, 15%, 26%)" },
      filter: [
        "all",
        ["==", "$type", "Polygon"],
        ["!has", "brunnel"],
    ...
    },
    {
      ...
      metadata: {},
      filter: ["in", "class", "pitch", "stadium", "playground"],
    },
    {
      id: "School",
      type: "fill",
      ...
      metadata: {},
      filter: ["in", "class", "college", "school", "university"],
    },
    {
      id: "River tunnel",
      type: "line",
    ...
    },
    {
      ...
      "source-layer": "transportation",
      layout: { visibility: "visible" },
      paint: { "fill-antialias": true, "fill-color": "hsl(215, 15%, 23%)" },
      metadata: {},
    ...
    },
    {
      ...
      maxzoom: 15,
      layout: { visibility: "visible" },
      paint: { "fill-color": "hsl(217, 47%, 51%)", "fill-opacity": 0.3 },
      metadata: {},
    },
    {
      id: "Building 3D",
    ...
    },
    {
      ...
      paint: {
        "icon-color": "hsl(203, 78%, 34%)",
        "icon-halo-color": "hsl(216, 95%, 9%)",
        "text-color": "hsl(203, 78%, 34%)",
        "text-halo-blur": 1,
        "text-halo-color": "hsl(216, 95%, 9%)",
        "text-halo-width": {
          stops: [
            [10, 1],
            [18, 2],
    ...
    },
    {
      ...
      paint: {
        "icon-color": "hsl(203, 82%, 32%)",
        "icon-halo-color": "hsla(216, 95%, 9%, 0.75)",
        "icon-halo-width": 1.5,
        "text-color": "hsl(203, 82%, 32%)",
        "text-halo-color": "hsla(216, 95%, 9%, 0.75)",
        "text-halo-width": 1.5,
      },
      metadata: {},
    ...
    },
    {
      ...
      paint: {
        "icon-color": "hsl(205, 76%, 34%)",
        "icon-halo-color": "hsla(0, 0%, 12%, 0.15)",
        "text-color": "hsl(205, 76%, 34%)",
        "text-halo-blur": 0.5,
        "text-halo-color": "hsla(0, 0%, 12%, 0.15)",
        "text-halo-width": 1,
      },
      filter: ["==", "class", "ferry"],
    },
    ...
    },
    {
      ...
      paint: {
        "icon-color": "hsl(0, 0%, 6%)",
        "icon-halo-color": "hsl(0, 3%, 87%)",
        "icon-halo-width": 1,
        "text-color": "hsl(0, 0%, 100%)",
        "text-halo-blur": 0,
        "text-halo-color": "hsl(0, 0%, 100%)",
    ...
    },
    {
      ...
      paint: {
        "icon-color": "hsl(215, 99%, 65%)",
        "icon-halo-blur": 0.5,
        "icon-halo-color": "hsl(0, 0%, 0%)",
        "icon-halo-width": 1,
        "icon-opacity": 1,
        "text-color": "hsl(215, 99%, 65%)",
        "text-halo-blur": 0.5,
        "text-halo-color": "hsl(0, 0%, 0%)",
        "text-halo-width": 1,
      },
      filter: ["all", ["has", "iata"], ["!in", "class", "public"]],
    },
    {
      id: "State labels",
      type: "symbol",
      ...
      paint: {
        "icon-color": "hsl(0, 0%, 74%)",
        "icon-halo-color": "hsla(0, 0%, 12%, 0.75)",
        "text-color": "hsl(0, 0%, 74%)",
        "text-halo-color": "hsla(0, 0%, 12%, 0.75)",
        "text-halo-width": 0.8,
        "text-opacity": [
          "step",
          ["zoom"],
  ...
  glyphs:
    "https://api.maptiler.com/fonts/{fontstack}/{range}.pbf?key=Ql4Zhf4TMUJJKxx8Xht6",
  sprite:
    "https://api.maptiler.com/maps/11f9cb7f-c7e2-4dfc-9b0e-b528d9038d7b/sprite",
  bearing: 0,
  pitch: 0,
  center: [0, 0],
  zoom: 1,
