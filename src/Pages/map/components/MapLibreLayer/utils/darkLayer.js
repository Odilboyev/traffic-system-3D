export const darkLayer = {
  ...
  sprite: "https://wms.wheregroup.com/tileserver/sprites/fiord-color",
  glyphs:
  ...
  layers: [
    ...
    },
    {
      ...
      layout: {
        "symbol-placement": "line",
        "symbol-spacing": 350,
        "text-field": ["coalesce", ["get", "ref:en"], ["get", "ref:latin"], ["get", "ref"]],
        "text-font": ["Noto Sans Light"],
        "text-pitch-alignment": "viewport",
    ...
    },
    {
      ...
      layout: {
        "text-field": ["coalesce", ["get", "name:en"], ["get", "name:latin"], ["get", "name"]],
        "text-font": ["Noto Sans Light Italic"],
        "text-size": {
          base: 1,
          stops: [
            [0, 9],
