...
import { WiDaySunny, WiCloudy, WiRain, WiSnow, WiStrongWind, WiHumidity, WiBarometer } from 'react-icons/wi';
import { FaTemperatureHigh, FaTemperatureLow, FaMapMarkerAlt, FaCalendarAlt } from 'react-icons/fa';
...
const WeatherModule = () => {
  ...
  // Weather alerts
  const alerts = [
    { type: 'Kuchli shamol', severity: 'moderate', time: '15:00 - 18:00', areas: ['Markaziy', 'Shimoliy'] },
    { type: 'Yomg\'ir', severity: 'low', time: 'Ertaga 10:00 - 14:00', areas: ['Janubiy', 'G\'arbiy'] }
  ];
      ...
      <div className="p-4 bg-gray-800/50 backdrop-blur-sm rounded-lg">
        <div className="flex items-start justify-between">
          ...
          <div className="text-right">
            <div className="text-3xl font-bold text-cyan-100">{currentWeather.temperature}°C</div>
            <p className="text-xs text-gray-400">Seziladi: {currentWeather.feelsLike}°C</p>
          </div>
        </div>
        ...
        <div className="mt-4 flex justify-between items-center">
          <div className="flex flex-col items-center">
            ...
            <span className="text-sm text-gray-300 mt-1">
              {currentWeather.condition === 'sunny' ? 'Quyoshli' : 
               currentWeather.condition === 'cloudy' ? 'Bulutli' : 
               currentWeather.condition === 'rain' ? 'Yomg\'irli' : 'Qorli'}
            </span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="text-md font-medium text-cyan-100">{currentWeather.humidity}%</div>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="text-md font-medium text-cyan-100">{currentWeather.wind} km/s</div>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="text-md font-medium text-cyan-100">{currentWeather.pressure} hPa</div>
              </div>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="flex items-center space-x-3">
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium text-gray-300">{day.high}°</span>
                </div>
                <div className="flex items-center">
                  <FaTemperatureLow className="text-blue-400 mr-1" />
                  <span className="text-sm font-medium text-gray-300">{day.low}°</span>
                </div>
              </div>
            </div>
          ))}
            ...
            {alerts.map((alert, index) => (
              ...
              >
                <div className="flex justify-between items-start">
                  <h4 className="text-md font-medium text-cyan-100">{alert.type}</h4>
                  <span className={`text-xs px-2 py-1 rounded-full ${getSeverityColor(alert.severity)}`}>
                    {alert.severity === 'high' ? 'Yuqori' : 
                     alert.severity === 'moderate' ? 'O\'rta' : 'Past'}
                  </span>
                </div>
