...
const CustomMarker = memo(
  function CustomMarker({
    ...
    const markerIcon = useMemo(
      () =>
        ...
        L.icon({
          ...
          iconSize: marker.type === 2 ? [24, 24] : [28, 28],
          iconAnchor: marker.type === 2 ? [13, 12] : [15, 14], // centerdan chaproqda joylashdi
        }),
    ...
    const markerPosition = useMemo(() => {
      if (position) {
        return position.alt !== undefined
          ? [position.lat, position.lng, position.alt]
